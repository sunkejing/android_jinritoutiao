...
public class BindPhoneNumberModelImpl implements BindPhoneNumberModel {
    ...
    @Override
    public void onQueryOAuthCode(Context context, final RequestCallback<Authorize> requestCallback) {
        HashMap<String, Object> mHashMap = new HashMap<String, Object>();
        mHashMap.put("scope", "user_info");
